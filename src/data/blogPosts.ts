...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "Como organizar suas finanças pessoais com uma planilha simples e eficaz.",
    content:
      "O controle financeiro é fundamental para alcançar seus objetivos financeiros. Uma planilha bem estruturada pode te ajudar a acompanhar receitas, despesas, investimentos e muito mais. Recomendamos criar categorias para suas despesas como moradia, alimentação, transporte, lazer e investimentos. É importante anotar todas as movimentações financeiras, por menor que sejam. Com o tempo, você conseguirá identificar padrões de gastos e oportunidades de economia. Existem várias ferramentas gratuitas como Google Sheets e Excel que podem te ajudar. O importante é manter a consistência e atualizar sua planilha regularmente.",
